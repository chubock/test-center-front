...
export class UserQuestionsComponent implements OnInit{
  ...
  questionTypeKeys:string[] = ["Data Interpretation Set", "Numeric", "Quantitative", "Reading Comprehension", "Sentence Equivalence", "Text Completion", "Writing"];

  questionTypeMap:Map<string, Array<string>> = new Map(
    [
      ["Data Interpretation Set", ["GRE_DATA_INTERPRETATION_SET_MULTIPLE_ANSWER", "GRE_DATA_INTERPRETATION_SET_NUMERIC", "GRE_DATA_INTERPRETATION_SET_SINGLE_ANSWER"]],
      ["Numeric", ["GRE_NUMERIC", "GRE_NUMERIC_FRACTION"]],
      ["Quantitative", ["GRE_QUANTITATIVE_COMPARISON", "GRE_QUANTITATIVE_MULTIPLE_ANSWER", "GRE_QUANTITATIVE_SINGLE_ANSWER"]],
      ["Reading Comprehension", ["GRE_READING_COMPREHENSION_SELECT_IN_PASSAGE", "GRE_READING_COMPREHENSION_MULTIPLE_ANSWER", "GRE_READING_COMPREHENSION_SINGLE_ANSWER"]],
      ["Sentence Equivalence", ["GRE_SENTENCE_EQUIVALENCE"]],
      ["Text Completion", ["GRE_TEXT_COMPLETION_ONE_BLANK", "GRE_TEXT_COMPLETION_TWO_BLANK", "GRE_TEXT_COMPLETION_THREE_BLANK"]],
      ["Writing", ["GRE_WRITING_ARGUMENT", "GRE_WRITING_ISSUE"]]
    ]
  );
  ...
  filtersChangeListener(filters:string[], items:string[]) {
    items.forEach(item => this.filterChangeListener(filters, item));
  }
